...
const (
	TemplateService_ListTemplates_FullMethodName       = "/mailkite.newsletter.template.v1.TemplateService/ListTemplates"
	TemplateService_GetTemplate_FullMethodName         = "/mailkite.newsletter.template.v1.TemplateService/GetTemplate"
	TemplateService_CreateTemplate_FullMethodName      = "/mailkite.newsletter.template.v1.TemplateService/CreateTemplate"
	TemplateService_UpdateTemplate_FullMethodName      = "/mailkite.newsletter.template.v1.TemplateService/UpdateTemplate"
	TemplateService_DeleteTemplate_FullMethodName      = "/mailkite.newsletter.template.v1.TemplateService/DeleteTemplate"
	TemplateService_MarkDefaultTemplate_FullMethodName = "/mailkite.newsletter.template.v1.TemplateService/MarkDefaultTemplate"
)
...
//
// TemplateService manages reusable layouts for campaigns and transactional
// messages.
type TemplateServiceClient interface {
	...
	MarkDefaultTemplate(ctx context.Context, in *MarkDefaultTemplateRequest, opts ...grpc.CallOption) (*Template, error)
}
...
func (c *templateServiceClient) MarkDefaultTemplate(ctx context.Context, in *MarkDefaultTemplateRequest, opts ...grpc.CallOption) (*Template, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Template)
	err := c.cc.Invoke(ctx, TemplateService_MarkDefaultTemplate_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TemplateServiceServer interface {
	...
	// Marks a template as the default for its type.
	MarkDefaultTemplate(context.Context, *MarkDefaultTemplateRequest) (*Template, error)
...
func (UnimplementedTemplateServiceServer) MarkDefaultTemplate(context.Context, *MarkDefaultTemplateRequest) (*Template, error) {
	return nil, status.Error(codes.Unimplemented, "method MarkDefaultTemplate not implemented")
}
...
func _TemplateService_MarkDefaultTemplate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(MarkDefaultTemplateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TemplateServiceServer).MarkDefaultTemplate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TemplateService_MarkDefaultTemplate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TemplateServiceServer).MarkDefaultTemplate(ctx, req.(*MarkDefaultTemplateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TemplateService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "mailkite.newsletter.template.v1.TemplateService",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "MarkDefaultTemplate",
			Handler:    _TemplateService_MarkDefaultTemplate_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "mailkite/newsletter/template/v1/template_service.proto",
}
